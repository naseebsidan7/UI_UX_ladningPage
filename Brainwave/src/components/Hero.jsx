    ...
    <Section
        ...
        <div className='container relative' ref={parallaxRef}>
            <div className='relative z-1 max-w-[62rem]
                            mx-auto text-center mb-[3.875rem]
                            md:mb-20 lg:mb-[6.25rem]'
            >
                <h1 className='h1 mb-6'>
                  Explore the Possibilities of&nbsp;AI&nbsp;Chatting with {` `}
                  <span className='inline-block relative' >Brainwave {" "}
                   <img src={curve} className='absolute top-full left-0 w-full xl:-mt-2' width={624} height={28} alt='Curve'/></span>
                </h1>
                <p className='body-1 text-n-2 max-w-3xl mx-auto
                              mb-6 lg:mb-8'>
