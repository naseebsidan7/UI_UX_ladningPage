...
const PricingList = () => {
  return (
    <div className='flex gap-[1rem] max-lg:flex-wrap'>
         {pricing.map((item) => (
            <div key={item.id}
                 className='w-[19rem] max-lg:w-full border
                            border-n-6 bg-n-8 rounded-[2rem] 
                            h-full px-6 lg:w-auto even:py-14 odd:py-8 odd:my-4
                 ...
                 <Button className='w-full mb-6' 
                         href={item.price? '/pricing' : 'mailto:naseebsidan6@gmail.com'}
                         white={!!item.price}
                         >
